...
public class ShowUsersViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
    ...
    public ItemClickListner itemListclik;
    ...
    public ShowUsersViewHolder(@NonNull View itemView) {
        ...
        block_user = (Button) itemView.findViewById(R.id.editblock_user);
    ...
    public void setItemListclik(ItemClickListner itemListclik) {
